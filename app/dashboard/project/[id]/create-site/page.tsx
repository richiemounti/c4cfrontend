// app/dashboard/project/[id]/create-site/page.tsx
'use client';
...
const CreateSitePage = ({ params }: { params: PageParams }) => {
  ...
  useEffect(() => {
    ...
    const fetchProjectData = async () => {
      try {
        ...
        setIsLoadingProject(false); // Set loading to false regardless of success/failure
      }
    };
