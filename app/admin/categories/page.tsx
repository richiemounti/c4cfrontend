...
// Import useSearchParams at the top level inside the CategoriesContent component
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Validate that initialStatus is a valid TaxonomyStatus
        ...
        // Now it's safe to pass to fetchCategories
        const categoriesResponse = await fetchCategories({
            page: initialPage,
            limit,
            search: initialSearch,
            status: initialStatus !== 'all' ? initialStatus as Exclude<TaxonomyStatus, 'all'> : undefined
        });
