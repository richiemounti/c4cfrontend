...
const HelpPageTemplate: FC<HelpPageTemplateProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-neutral-tint">
      <BreadcrumbNav section={section} title={title} />
      
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <h1 className="text-2xl font-semibold mb-3 text-ink">{title}</h1>
            <p className="text-ink/80 mb-6 text-lg">{description}</p>
            <div className="text-sm text-ink/70 mb-8">Last updated: {lastUpdated}</div>
          ...
          <div className="mt-8 text-center">
            <Link 
              href="/support" 
              className="inline-flex items-center text-neutral hover:text-neutral-500 font-medium"
            >
              <svg 
