    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white border-stone-500/20">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm text-ink-900">
            Project Context
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 text-sm">
          ...
          <div>
            <span className="text-neutral-600">Survey Category:</span>
            <div className="font-medium text-ink-900 mt-1">
        ...
        <CardContent className="space-y-4">
          <div>
            <div className="flex justify-between text-sm mb-2">
              ...
              <span className="text-ink-900">{Math.round(stepProgress())}%</span>
            </div>
                ...
                <div key={step.key} className="flex items-center gap-3">
                  <div className={`
                    ...
                    ${status === 'completed' ? 'bg-emerald-100 text-emerald-700' :
                      status === 'current' ? 'bg-neutral-100 text-neutral-700' :
                  ...
                  <span className={`text-sm ${
                    status === 'current' ? 'font-medium text-ink-900' : 'text-neutral-600'
                  }`}>
                    {step.label}
                  </span>
                </div>
      ...
      <Card className="bg-white border-stone-500/20">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm text-ink-900 flex items-center gap-2">
        ...
        <CardContent className="space-y-4">
          ...
          {formData.title && (
            <div>
              ...
              <div className="font-medium text-ink-900 text-sm mt-1 line-clamp-2">
                {formData.title}
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="text-center p-3 bg-ink-50 rounded-lg">
              <div className="text-lg font-bold text-neutral-500">{totalQuestions}</div>
              <div className="text-xs text-ink-600">Questions</div>
            </div>
            <div className="text-center p-3 bg-ink-50 rounded-lg">
              <div className="text-lg font-bold text-gold-500">{totalSections}</div>
              <div className="text-xs text-ink-600">Sections</div>
            </div>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-neutral-600">Conditional:</span>
              <Badge variant="outline" className="text-xs">
                {questionsWithLogic}
              </Badge>
            </div>
        ...
        <Card className="bg-white border-stone-500/20">
          ...
          <CardContent className="space-y-3 text-sm text-neutral-600">
            <div className="flex items-start gap-2">
              <div className="w-1 h-1 bg-neutral-500 rounded-full mt-2 flex-shrink-0"></div>
