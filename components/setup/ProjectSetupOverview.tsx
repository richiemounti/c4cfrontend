// components/setup/ProjectSetupOverview.tsx
import { useEffect, useState } from 'react';
import { useRouter } from 'next/navigation';
import Link from 'next/link';
import { initializeProjectSetup, getProjectSetup, getProjectSetupProgress } from '@/lib/api/projectSetup';
...
interface ProjectSetupOverviewProps {
  projectId: string;
}

export default function ProjectSetupOverview({ projectId }: ProjectSetupOverviewProps) {
