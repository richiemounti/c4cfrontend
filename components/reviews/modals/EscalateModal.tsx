    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b border-stone-500">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-coral-50 rounded-lg">
              <ArrowUpCircle className="w-5 h-5 text-coral-900" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          {/* Warning Notice */}
          <div className="mb-6 p-4 bg-coral-50 border border-coral-100 rounded-lg">
            <div className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-coral-900 mt-0.5 flex-shrink-0" />
              <div className="flex-1">
                <p className="text-sm font-medium text-coral-900 mb-1">
                  Important Notice
                </p>
          ...
          <div className="mb-6">
            <label className="text-sm font-medium text-ink-900 mb-2 block">
              Reason for Escalation <span className="text-burgundy-900">*</span>
            </label>
            <textarea
              value={reason}
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <button
                  ...
                  className="px-3 py-2 text-xs border border-stone-500 rounded-lg hover:bg-stone-50 transition-colors text-left"
                >
                  {quickReason}
                </button>
              ))}
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-coral-500 text-white rounded-lg hover:bg-coral-900 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
