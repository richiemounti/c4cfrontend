  ...
  return (
    <ResponsiveContainer width="100%" height={chartHeight}>
      <BarChart data={items} layout="vertical" margin={{ left: 8, right: 24 }}>
        ...
        <XAxis type="number" domain={domain} tick={{ fill: '#1a1814', fontSize: 12 }} unit={valueSuffix} />
        <YAxis type="category" dataKey="label" width={160} tick={{ fill: '#1a1814', fontSize: 12 }} />
